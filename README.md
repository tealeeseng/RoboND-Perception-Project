For my project writeup, please refer [project3-writeup.md](project3-writeup.md)
Perception pipeline source code can be found at [project3.py](pr2_robot/scripts/project3.py)
